...
class Notebook():
    ...
    GunDuck = textwrap.fill("\033[1m" + "Note: The Gun Ducks\n" + "\033[0m" + "Gun Ducks are rare lakeside inhabitants that are ducks which have a gun for a bill. They fly in squadrons and are only able to be observed when they aren't aware of your presence as they harass anything that breathes. A group of them is called a Great Potoo Squadron.\nBehavior: Incredibly Aggressive Towards Anything That Breathes\nPreferred Food: Blood of their Enemies.", width=150)
